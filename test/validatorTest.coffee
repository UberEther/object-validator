# todo: This is really an integration test more than a unit test - should make better factored unit tests...

expect = require("chai").expect
generateValidator = require "../lib"
defaultFieldTypes = require "../lib/defaultFieldTypes"
